"""
Django settings for Herozion project.
...
import os
from dotenv import load_dotenv  # 1. Importez la bibliothèque

# Build paths inside the project like this: BASE_DIR / 'subdir'.
BASE_DIR = Path(__file__).resolve().parent.parent
load_dotenv(BASE_DIR / '.env')  # 2. Chargez le fichier .env
...
WSGI_APPLICATION = 'Herozion.wsgi.application'
...
STATIC_ROOT = BASE_DIR / 'public/static'  # Répertoire où collectstatic placera les fichiers statiques
